  ...
  return (
    <div>
      {toDos.map((toDo, index) => (
        <div
          key={index}
          className="mt-5 max-w-sm mx-auto border-2 border-teal-300 p-6 rounded-lg shadow-md"
        >
          <svg
          ...
          <h2 className="font-semibold mt-4 text-xl">{toDo.title}</h2>
          <p className="mt-3 text-slate-400 px-2 text-lg">"{toDo.desc}"</p>
          <p className="mt-3 px-2 text-slate-400">{toDo.due_date}</p>
